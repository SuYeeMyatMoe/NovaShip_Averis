  ...
  return (
    <div className="grid min-w-0 max-w-full gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
      <div className="min-w-0 rounded-xl border border-ink-200 bg-white p-4">
        ...
        <p className="break-words text-xs text-ink-500">security_precheck, security_agent, classify, detect_documents, extract, compare (deterministic), summarize_and_draft, human_review (interrupt), notify. Full console on <Link href="/workbench" className="text-accent hover:underline">Workbench</Link>.</p>
